...
namespace Infrastructure.Data.Migraions
{
    ...
    [Migration("20230113193112_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Enitites.Breeds.Animal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Enitites.Breeds.Breed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Enitites.Breeds.Breed", b =>
                {
                    b.HasOne("Core.Enitites.Breeds.Animal", "Animal")
                        .WithMany("Breeds")
            ...
            modelBuilder.Entity("Core.Enitites.Pet", b =>
                {
                    b.HasOne("Core.Enitites.Breeds.Breed", "Breed")
                        .WithMany("Pets")
